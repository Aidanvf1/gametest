...
# Modify the main game loop to be async
async def main():
    global game_active, start_time, score, player_gravity, obstacle_rect_list
    global bird_surf, bird_frame_index, frog_surf, frog_frame_index  # Add these globals
    ...
    while True:
        ...
        pygame.display.update()
        clock.tick(60)
        await asyncio.sleep(0)  # Add this line to make it work with pygbag

# Add this at the bottom instead of running the while loop directly
asyncio.run(main())
